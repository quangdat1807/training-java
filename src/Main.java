...
import managerEl.Human;
import managerEl.Student;
import managerEl.Worker;
...
public class Main {
    public static void main(String[] args) {
        Student s1 = new Student("Dao", "Quang ", 2);
        Student s2 = new Student("Dat", "Dao ", 1);
        Student s3 = new Student("Nguyen", "Tran ", 5);
        Student s4 = new Student("Pham", "Le ", 7);
        ...
        List<Student> listStudent = new ArrayList<>(10);
        listStudent.add(s1);
        listStudent.add(s2);
        listStudent.add(s3);
        listStudent.add(s4);
        ...
        Worker w1 = new Worker("IT", "QA", 5215, 2);
        Worker w2 = new Worker("TP", "BA", 1500, 8);
